...
app.get("/", (req, res) => {
  allPost.find({}, function(err, posts){
  ...
  // res.render("home", { value: homeStartingContent, allPost });
  // console.log(allPost);
});
...
//   allPost.map((post) => {
//     var url = _.lowerCase(post.postTitle);
//   const requestedPostId = req.params.postId;

//     // var url2 = _.lowerCase(req.params.postname);
//     // if (url === url2) {
//       // res.render("post", {
...
app.get("/posts/:postId", function(req, res){
  ...
  const requestedPostId = req.params.postId;
    ...
    allPost.findOne({_id: requestedPostId}, function(err, post){
      res.render("post", {
        title: post.postTitle,
        body: post.postBody
      });
